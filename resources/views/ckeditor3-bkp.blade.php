    ...
    <body>
        ...
        <div id="container">
            ...
            <form method="POST" action="/ckeditor_func">
                ...
                <!-- <div id="editor"></div> -->
                <button class="btn btn-success mt-4" type="submit">Submit</button><br><br>           

            </form>

            <button class="view_btn btn-success mt-4" type="button">View Submmited Form</button><br><br>           
        ...
        <script>
            ...
            editornw.setData( '<p>Some text.</p>' );
