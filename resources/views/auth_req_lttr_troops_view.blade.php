              ...
              <table class="table stripe hover row-border order-column" id="table_auth_req_lttr_troops">
                ...
                @foreach($supplier as $sup)
                  <tr>
                      ...
                      <td>{{$sup->auth_given_by}}</td>
                      <td>{{$sup->transport_date}}</td>
                      <td>{{$sup->organization}}</td>
                      <td>{{$sup->no_of_troops}}</td>
                      <td>
                        <span id="{{$sup->id}}" class="btn btn-primary view" data-toggle="modal" data-target="#TrackModal">Track</span>
                        <span id="{{$sup->id}}" class="btn btn-primary view" data-toggle="modal" data-target="#ViewModal">View</span>
                        <a target="_blank" href="{{route('auth_req_lttr_troops')}}/{{$sup->id}}" id="{{$sup->id}}" class="btn btn-success edit">Edit</a>
                      </td>
                  </tr>
                @endforeach
                </tbody>
...
<script>
  ...
  $(document).ready(function() {
        ...
        // $.ajax({
        //     url:"{{ url('') }}/auth_req_lttr_troops_view_func",
        //     method:'POST',
