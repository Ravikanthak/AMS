    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item settings_li">
                ...
                @if(Auth::user()->user_type ==2 || auth()->user()->can('role-management'))
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                @if(Auth::user()->user_type ==2 || auth()->user()->can('user-management'))
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('create_user')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                ...
                @if(Auth::user()->user_type ==2 || auth()->user()->can('add-organization-armory'))
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                @if(Auth::user()->user_type ==2 || auth()->user()->can('view-organization-resources'))
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
