        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    @else
                        <h1>Create Organization User</h1>
                    @endif
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 offset-md-8">
                                <div class="form-group">
                                    <label for="officer_number" class="form-label">Officer/soldier Number</label>
                                    ...
                                    @else
                                        <form method="POST" action="{{route('admin.update',$id)}}">
                                            ...
                                            <div class="row mt-5">
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="text" class="form-control"
                                                               name="full_name"
                                                               id="full_name"
                                                               value="{{ isset($editUser[0]->full_name)?$editUser[0]->full_name:''}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <label for="active_service" class="form-label">Active
                                                            Service</label>
                                                        <input readonly type="text" class="form-control"
                                                               name="active_service"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="service_number" class="form-label">Service
                                                            Number</label>
                                                        <input readonly type="text" class="form-control"
                                                               name="service_number"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="text" class="form-control" name="rank"
                                                               id="rank"
                                                               value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="text" class="form-control" name="nic"
                                                               id="nic"
                                                               value="">
                                                    </div>
                                                </div>
                                                ...
                                                @if(Auth::user()->user_type !=1)
                                                    <div class="col-md-12 ">
                                                        <div class="form-group mb-3">
                                                            <label for="user_type" class="form-label">Appointment</label>
                                                    ...
                                                    <div class="form-group pl-4 mt-4">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input"
                                                                   ...
                                                                   role="switch" id="admin_status"
                                                                   name="admin_status">
                                                            <label class="form-check-label label-font-weight"
                                                                   for="availability">Account
                                                                Active</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group text-right">
                                                        <button id="create_user" type="submit"
                            ...
                            @foreach ($admins as $admin)
                                <tr id="{{$admin->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a class="ml-2 btn btn-sm btn-warning admin-edit"
                                           href="admin/{{$admin->id}}/edit">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                            <tbody>
